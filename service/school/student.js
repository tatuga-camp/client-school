...
export async function GetAllStudentsNumber() {
  try {
    ...
    const students = await axios.get(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/get-student-number`,
      {
        headers: {
...
export async function GetAllStudentsByNationlity() {
  try {
    ...
    const access_token = cookies.access_token;
    const students = await axios.get(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/get-students-by-nationality`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${access_token}`,
...
export async function GetAllStudentsInTeacherByNationlity({ teacherId }) {
  try {
    ...
    const access_token = cookies.access_token;
    const students = await axios.get(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/teacher/get-students-by-nationality`,
      {
        params: {
          teacherId: teacherId,
        },
...
export async function CreateStudentInStudentClassService({
  ...
  try {
    ...
    const students = await axios.post(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/create`,
      {
        number,
        firstName,
        lastName,
...
export async function UpdateStudentInStudentClassService({
  ...
  try {
    ...
    const students = await axios.put(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/update`,
      {
        number,
        firstName,
        lastName,
...
export async function DeleteStudentInStudentClassService({ studentId }) {
  try {
    ...
    const students = await axios.delete(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/delete`,
      {
        params: {
          studentId: studentId,
        },
...
export async function GetAllStudentInStudentClassService({ studentClassId }) {
  try {
    ...
    const access_token = cookies.access_token;
    const students = await axios.get(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student/get-all`,
      {
        params: {
          studentClassId,
        },
