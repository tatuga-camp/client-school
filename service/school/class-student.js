...
export async function CreateClassStudentService({
  ...
  try {
    ...
    const classStudent = await axios.post(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student-class/create`,
  ...
  try {
    ...
    if (nextId) {
      const classStudent = await axios.get(
        `${process.env.MAIN_SERVER_URL}/user/schoolUser/student-class/get-all`,
        {
          params: {
            cursor: nextId,
          },
...
export async function UpdateClassStudentService({
  ...
  try {
    ...
    const classStudent = await axios.put(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student-class/update`,
...
export async function DeleteStudentClassService({ studentClassId }) {
  try {
    ...
    const classStudent = await axios.delete(
      `${process.env.MAIN_SERVER_URL}/user/schoolUser/student-class/delete`,
      {
        params: {
          studentClassId,
        },
